...
def fetch_youtube(
    ...
    ydl_opts = {} # 参数不设置的话可以成功下载 
    #test_video_local = '/Users/jade_mayer/projects/tts_clone/turnvoice/TurnVoice/turnvoice/core/Quantum_Computing_Course_Math_and_Theory_for_Begin.mp4'
    #if not os.path.exists(test_video_local):
